...
class Classifier(pl.LightningModule):
    ...
    def __init__(
        ...
        self.cnn_layers = nn.Sequential(
            ...
            nn.BatchNorm1d(hidden_dim),
            nn.SiLU(inplace=True),
            # Corrected convolution: using hidden_dim instead of hidden_dim*2
            nn.Conv1d(hidden_dim, hidden_dim, kernel_size=3, padding=1, bias=False, stride=2),
            nn.BatchNorm1d(hidden_dim),
            nn.SiLU(inplace=True),
            nn.Dropout(dropout),
            ...
            nn.BatchNorm1d(hidden_dim*2),
            nn.SiLU(inplace=True),
            nn.Conv1d(hidden_dim*2, hidden_dim*2, kernel_size=3, padding=1, bias=False, stride=2),
            nn.BatchNorm1d(hidden_dim*2),
            nn.SiLU(inplace=True),
            nn.Dropout(dropout),
            ...
            nn.BatchNorm1d(hidden_dim*4),
            nn.SiLU(inplace=True),
            nn.Conv1d(hidden_dim*4, hidden_dim*4, kernel_size=3, padding=1, bias=False, stride=2),
            nn.BatchNorm1d(hidden_dim*4),
            nn.SiLU(inplace=True),
            nn.Dropout(dropout),
