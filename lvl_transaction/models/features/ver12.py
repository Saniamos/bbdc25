...
if __name__ == "__main__":
    ...
    X_val[X_val['AccountID'] == 'C5212792228'][['Hour', 'HourDiff', 'Action', 'Amount', 'External', 'External_Type', 'NewBalance', 'OldBalance', 'OrigAmount', 'isUnauthorizedOverdraft', 'RevTunnelCashFlagIn', 'cum_in_rev', 'RevTunnelCashFlagOut']].to_csv('test.csv')